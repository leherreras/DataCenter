...
import co.edu.sena.facade.InventarioFacade;
...
public class InventarioController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.InventarioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("InventarioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("InventarioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("InventarioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
