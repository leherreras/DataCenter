...
import co.edu.sena.facade.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.ProveedorFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ProveedorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ProveedorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ProveedorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
