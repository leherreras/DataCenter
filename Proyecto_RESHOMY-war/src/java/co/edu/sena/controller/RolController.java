...
import co.edu.sena.facade.RolFacade;
...
public class RolController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.RolFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("RolCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("RolUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("RolDeleted"));
        if (!JsfUtil.isValidationFailed()) {
