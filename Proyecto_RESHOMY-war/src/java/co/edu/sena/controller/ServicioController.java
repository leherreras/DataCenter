...
import co.edu.sena.facade.ServicioFacade;
...
public class ServicioController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.ServicioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ServicioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ServicioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ServicioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
