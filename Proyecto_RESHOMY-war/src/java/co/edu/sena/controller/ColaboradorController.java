...
import co.edu.sena.facade.ColaboradorFacade;
...
public class ColaboradorController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.ColaboradorFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ColaboradorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ColaboradorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ColaboradorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Colaborador getColaborador(java.lang.Integer id) {
    ...
    public static class ColaboradorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Colaborador) {
                ...
                return getStringKey(o.getIdColaborador());
            } else {
