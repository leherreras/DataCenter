...
import co.edu.sena.facade.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private co.edu.sena.facade.ClienteFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ClienteCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ClienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Titulos/Bundle").getString("ClienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
